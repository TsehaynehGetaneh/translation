...
const Page: React.FC = () => {
  ...
  return (
    <div className="mt-10">
      <h1 className="text-center text-3xl font-extrabold text-customeprimary">
        Get a Quote
      </h1>
      <p className="text-center text-lg mt-2 font-semibold text-customeprimary">
        Client Information
      </p>
      <div className="flex items-center justify-center p-6">
        <div className="mx-auto w-full max-w-4xl">
          <form onSubmit={handleSubmit}>
            ...
            <h1 className="text-center my-5 text-xl font-bold text-customeprimary">
              Project Details
            </h1>
            <div className="-mx-3 flex flex-wrap">
              <div className="w-full px-3 sm:w-1/2">
            ...
            <div className="-mx-3 flex flex-wrap">
              ...
              <div className="w-full px-3 sm:w-1/2">
                <SelectField
                  ...
                  options={[
                    {
                      value: "Select Volume Of Content!",
                      label: "Select Volume Of Content!",
                    },
            ...
            <div className="-mx-3 flex flex-wrap">
              <div className="w-full px-3 sm:w-1/2">
                <SelectField
                  ...
                  options={[
                    {
                      value: "Select Subject Matter!",
                      label: "Select Subject Matter!",
                    },
                    ...
                    {
                      value: "Creative Arts/Entertainment",
                      label: "Creative Arts/Entertainment",
                    },
                    { value: "IT/Software", label: "IT/Software" },
                    {
                      value: "Financial/Economic",
                      label: "Financial/Economic",
                    },
                    {
                      value: "Turism/Hospitality",
                      label: "Turism/Hospitality",
                    },
                    { value: "Other", label: "Other" },
                  ]}
                />
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0">
                    <Calendar
                      mode="single"
                      selected={
                        formValues.date ? new Date(formValues.date) : undefined
                      } // Convert timestamp back to Date object for selection
            ...
            <div>
              <div className="-mx-3 flex flex-wrap">
                <div className="w-full px-3 sm:w-1/2">
                  <InputField
                    ...
                    placeholder="Additional Project Details(s)"
                ...
                <div className="w-full px-3 sm:w-1/2">
                  <SelectField
                    ...
                    options={[
                      {
                        value: "Select File format of source Content!",
                        label: "Select File format of source Content!",
                      },
              ...
              <div className="-mx-3 flex flex-wrap">
                <div className="w-full px-3 sm:w-1/2">
                  <SelectField
                    ...
                    options={[
                      {
                        value: "Prefered File Format for Delivery!",
                        label: "Prefered File Format for Delivery!",
                      },
                      { value: "Microsoft Word", label: "Microsoft Word" },
                      { value: "PDF", label: "PDF" },
                      { value: "Excel", label: "Excel" },
                ...
                <div className="w-full px-3 sm:w-1/2">
                  <SelectField
                    ...
                    options={[
                      {
                        value: "Select Additional Servieces!",
                        label: "Select Additional Servieces!",
                      },
              ...
              <h1 className="text-center my-5 flex-1 w-full text-xl font-bold text-customeprimary">
                Budget and Payment
              </h1>
              <div className="-mx-3 flex flex-wrap">
                <div className="w-full px-3 sm:w-1/2">
