  ...
  return (
    <div className="w-full mt-10">
      <form
        ...
        className="md:max-w-4xl mx-5 sm:max-w-lg max-w-xl  md:mx-auto"
      >
        <h1 className="text-xl md:w-full ax-w-3xl font-bold text-center mb-5 text-customeprimary capitalize">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <InputField
            ...
            id="experience"
            name="experience"
            placeholder="Years Of Subtitling/Localization/Voiceovering Experience"
          />
          <SelectField
            onChange={handleChange}
          ...
          <div className="relative w-full">
            <label className="absolute top-0  left-5 text-sm text-black mb-2 block">
              Your CV
            </label>
            <input
              type="file"
