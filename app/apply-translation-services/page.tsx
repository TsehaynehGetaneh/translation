  ...
  return (
    <div className="w-full mt-20 bg-gradient-to-r from-[#FEFEFE] to-[#FAFAFB]">
      <form
        ...
        className="md:max-w-4xl sm:max-w-lg max-w-xl  mx-auto "
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-1 gap-x-4">
          ...
          <InputField
            ...
            id="experience"
            name="experience"
            placeholder="Years Of Translation Experience"
          />
          <SelectField
            onChange={handleChange}
            ...
            options={[
              {
                value: "CAT Tools Proficience",
                label: "CAT Tools Proficience",
              },
          ...
          <div className="w-full">
            ...
            />
            <label className="absolute top-0 text-sm text-black mb-2 block">
              Your CV
            </label>
          </div>
        </div>
