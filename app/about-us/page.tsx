  ...
  return (
    <div>
      <Image
        ...
        height={200}
        alt="Banner Image"
        className=" w-full mx-auto rounded-lg  md:h-full object-cover filter "
      />
      ...
      <div
        className="grid grid-cols-2 mt-10 w-full p-10 rounded-md md:grid-cols-4 gap-4 items-center"
        style={{
      ...
      <div className="flex flex-col items-center mx-20  ">
        <div className="flex flex-col  lg:flex-row mt-8 lg:gap-10 lg:items-center justify-end items-center  mx-auto w-full lg:max-w-screen-xl">
          ...
          <div className="lg:w-1/2  mt-4 md:mt-0 leading-relaxed p-2">
            ...
            <p className="text-sm tracking-wide leading-6">
              {aboutUsData.whatSetsUsApart.textOne}
            </p>
            <p className="text-sm mt-5 tracking-wide leading-6">
              {aboutUsData.whatSetsUsApart.textTwo}
            </p>
          </div>
        </div>
      </div>
