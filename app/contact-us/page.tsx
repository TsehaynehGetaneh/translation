    ...
    <div className='w-full relative'>
            ...
            <section className="mb-16 bg-white rounded-md shadow-lg flex flex-col md:flex-row items-stretch relative z-10">
              ...
              <div className="w-full md:w-1/2 mt-5 md:mt-2 pb-5 md:pl-4">
                <div className="flex ml-10 flex-col justify-center items-center md:items-start h-full">
                  <h1 className="text-xl mb-2 font-extrabold leading-none tracking-tight text-[#53AFFA] md:text-3xl">Visit Our Office</h1>
                  <div className="w-full md:w-9/12 xl:w-8/12 px-3 md:px-6">
                    <div className="mb-8">
                      <div className="flex items-center">
                        <MapPinned color='#53AFFA' />
                        <div className="ml-4">
                          <p className="font-bold text-[#343F62]">Main Office Address</p>
                          <p className="text-gray-900">Arkisha Main Road,<br /> Jinka, Ethiopia</p>
                    ...
                    <div className="mb-8">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-neutral-500 dark:text-neutral-200">+251912772136</p>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-neutral-500 dark:text-neutral-200">E-mail</p>
                        <p className="text-neutral-500 dark:text-neutral-200">info@hdtranslation.com</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className='w-full px-3'>
        <form onSubmit={handleSubmit} className='md:max-w-3xl sm:max-w-lg max-w-xl mx-auto'>
          <h1 className="text-3xl font-bold text-center mb-5 text-customeprimary">Get In Touch</h1>
