  ...
  return (
    <div className="flex items-center mt-10 justify-center mx-10">
      <div className="p-8 bg-white rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold text-[#343F52] mb-4">
        ...
        <ol className="list-decimal pl-6">
          <li className="mb-4">
            ...
            <p>
              HD Translation and Localization (&quot;we,&quot; &quot;us,&quot;
              or &quot;our&quot;) is committed to protecting the privacy and
              security of your personal information. This Data Protection &amp;
              Privacy Policy outlines how we collect, use, disclose, and protect
              your data when you engage with our translation and localization
              services.
            </p>
          </li>
          <li className="mb-4">
            ...
            <p>
              ...
              names, contact details, project-related information, and payment
              details. This information is collected directly from you or
          ...
          <li className="mb-4">
            ...
            <ul className="list-disc pl-6">
              <li>
                To provide translation and localization services as per your
                request.
              </li>
              <li>
                To communicate with you regarding project updates, inquiries,
                and support.
              </li>
          ...
          <li className="mb-4">
            ...
            <p>
              Refer to our Confidentiality statement for details on how we
              handle and safeguard your confidential information.
            </p>
          </li>
          <li className="mb-4">
          ...
          <li className="mb-4">
            ...
            <p>
              We implement reasonable and industry-standard security measures to
          ...
          <li className="mb-4">
            ...
            <p>
              ...
              law. Once the information is no longer needed, it will be securely
          ...
          <li className="mb-4">
            ...
            <p>
              We reserve the right to update this Data Protection &amp; Privacy
              Policy to reflect changes in our practices and legal requirements.
