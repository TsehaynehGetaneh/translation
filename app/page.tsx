...
import { CheckIcon, CircleCheck, Facebook, FacebookIcon, Instagram, InstagramIcon } from "lucide-react";
...
export default function Home() {
  ...
  <div className="">
    <div className="relative bg-[#7D7D7D] md:bg-white md:pl-12 pl-5">
      ...
      {/* Image */}
      <Image src={village} alt="Banner Image" className="md:absolute md:inset-0 md:w-full w-[90%] md:rounded-none mx-auto rounded-lg h-28 md:h-full object-cover filter brightness-[50%]" />
  
      {/* Content */}
      <div className="min-h-[400px] relative z-50 h-full mx-auto flex flex-col justify-center text-left text-white p-6">
        <h2 className="sm:text-4xl text-3xl leading-10 tracking-[0.01em] md:max-w-xl md:text-5xl font-bold mb-6">Professional Translation and localization Services</h2>
        <div className="flex flex-col md:flex-row items-center justify-between max-w-3xl font-bold text-xl text-white">
          <div className="flex items-center">
            ...
            <span className="tracking-wider text-lg">Native Translators</span>
          </div>
          <div className="flex items-center">
            <CircleCheck size={20} className="mr-3" />
            <span className="tracking-wider text-lg">Transparent Pricing</span>
          </div>
          <div className="flex items-center">
            <CircleCheck size={20} className="mr-3" />
            <span className="tracking-wider text-lg">Guaranteed Quality</span>
          </div>
        </div>
        <Button variant={'ghost'} className="md:w-28 border-customeprimary -z-10 mt-10 font-semibold rounded-lg bg-white text-customeprimary px-5">
          <Link href="/contact-us">Contact Us</Link>
        </Button>
      </div>
    </div>
    <hr className=" border-gray-300" />
    <div className="grid grid-cols-2 p-10 rounded-md md:grid-cols-4 gap-4 items-center"
      style={{ 
        ...
        <div className="">
          <div className="mt-10  mx-auto w-full">
            <div className="mb-32 max-w-7xl text-center mx-auto">
              <h2 className="md:text-4xl text-3xl font-bold mb-6 text-customeprimary">Why Choose Us?</h2>
              <p className="mt-6 max-w-6xl mx-auto text-center ">When you choose a translation company, you expect the best. Our professional 
