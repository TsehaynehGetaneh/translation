    ...
    <div className="sticky top-0 w-full z-50 h-24 bg-white flex justify-center items-center">
      <NavigationMenu>
        <NavigationMenuList>
          ...
          <NavigationMenuItem>
            <NavigationMenuTrigger className={cn("hover:text-customeprimary")}>
              Services
            </NavigationMenuTrigger>
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid z-50 gap-3 p-4 rounded-lg md:w-[200px] border-b-[6px] border-b-customeprimary ">
                <ListItem href="/languages">Languages</ListItem>
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid z-50 gap-3 p-4 rounded-lg md:w-[200px] border-b-[6px] border-b-customeprimary ">
                ...
                <ListItem href="/recruitment">Recruitment</ListItem>
              </ul>
            </NavigationMenuContent>
          </NavigationMenuItem>
        </NavigationMenuList>
      </NavigationMenu>
      <Button className="bg-customeprimary rounded-full p-2">
        Get a quote
      </Button>
    </div>
  );
