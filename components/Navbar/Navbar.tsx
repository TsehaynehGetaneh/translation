        ...
        <nav className=" flex h-[100px] whitespace-nowrap w-[80%] mx-auto items-center justify-between md:justify-center py-2 ">
          ...
          <Link href={"/"} className="cursor-pointer mr-10">
            <Image
              ...
              height={120}
            />
            <span className="text-xs text-green-500 font-bold pl-1  absolute top-20">
              Bridge the Gap
            </span>
          </Link>
          <div className="hidden md:flex items-center justify-center">
            <ul className="flex items-center gap-5">
              ...
              <li className="group relative cursor-pointer">
                <Link href="/" className="flex h-[35px] items-center gap-[2px]">
                  Services{" "}
                </Link>
                <div className="absolute -left-7  ease-in-out transition-all duration-700 transform scale-95 shadow-lg border-b-[6px] border-b-customeprimary rounded-lg z-[9999] hidden w-[250px] bg-white py-2 text-black group-hover:block  ">
                  <ul className="space-y-1">
                    ...
                    <li className="px-4 py-1 hover:bg-customeprimary hover:text-white">
                      <Link href="/transcription-services">
                        {" "}
              ...
              <li className="group relative cursor-pointer">
                <a href="/" className="flex h-[35px] items-center gap-[2px]">
                  Languages{" "}
                </a>
                <div className="absolute -left-7 border-b-[6px] border-b-customeprimary rounded-lg md:w-[170px] z-[9999] hidden w-[150px] bg-white py-2 text-black group-hover:block  ">
                  <ul className="space-y-1 ">
                    ...
                    <li className="py-1 px-4 hover:bg-customeprimary hover:text-white">
                      <Link href="/history-of-languages">
                        {" "}
            ...
            <Link href={"/get-a-quote"}>
              <Button
                size={"sm"}
                className="bg-customeprimary ml-20 inline cursor-pointer justify-self-end rounded-full  px-3"
              >
                Get a quote
              </Button>
            </Link>
